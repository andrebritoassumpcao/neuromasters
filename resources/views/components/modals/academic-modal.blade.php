    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('profissionalPerfil.createFormacao', ['id_profissional' => $user->id]) }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <x-campo-component inputType="text" inputName="instituicao_ensino" value="" :placeholder="'Digite a insituição de ensino'"
                        class="max-col">
                        <x-slot name="labelSlot">
                            Instituição de ensino:
                        </x-slot>
                    </x-campo-component>
                    <x-campo-component inputType="text" inputName="curso" value="" :placeholder="'Digite o curso'"
                        class="max-col">
                        <x-slot name="labelSlot">
                            Curso:
                        </x-slot>
                    ...
                    <x-campo-component inputType="textarea" inputName="especialidades" :placeholder="'Ex: especialidade em nutrição funcional integrativa'" value="">
                        <x-slot name="labelSlot">
